...
-- Schema dbproject221
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dbproject221` DEFAULT CHARACTER SET utf8 ;
-- -----------------------------------------------------
-- Schema dbproject221
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `dbproject221`.`announces` (
  ...
  INDEX `fk_announces_users1_idx` (`users_ID` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_announces_users1`
    ...
    REFERENCES `dbproject221`.`users` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1
